...
def get_stats(db: Session = Depends(get_db)):
    ...
    return {
        ...
        "eggs_growing": db.query(UserDragon).filter(UserDragon.completed_at == "").count(),
        "dragons_grown": db.query(UserDragon).filter(UserDragon.completed_at != "").count(),
...
def create_dragon_route(
    ...
    dragon = create_dragon(db, name, rarity, egg_type, description, family_id, image, silhouette, finale_image, finale_description, is_epic)
