...
- `epic_name_keyboard()` — при вводе имени эпического (Сменить яйцо / Помощь / Бестиарий; служебные слова garden/help/rules/start обрабатываются как команды, а не как имя)
- `epic_restart_keyboard()` — после финала эпического (Такого же заново / Случайного / Сменить яйцо / Помощь / Бестиарий)
- `await_garden_keyboard(with_cancel=True)` — при выборе дракона (без кнопки «Сменить яйцо»; кнопка «Не менять» показывается всегда)
- `shop_keyboard(items, page, total_pages)` — товары стадии + пагинация + Мой инвентарь + К эпическому дракону + Сменить яйцо (магазин)
- `inventory_keyboard()` — Магазин / К эпическому дракону / Сменить яйцо / Бестиарий (инвентарь)
...
- `care_shop_keyboard()` — Магазин / К дракону / Сменить яйцо / Правила / Помощь / Бестиарий (нужны товары для действия; «◀ К дракону» возвращает к текущему действию ухода)
- `sub_step_keyboard()` — Норма / Штраф(x2) / Сменить яйцо / Бестиарий (шаг составного действия)
- `sub_action_keyboard(...)` — варианты + Магазин / Сменить яйцо / Бестиарий (выбор составного действия)
